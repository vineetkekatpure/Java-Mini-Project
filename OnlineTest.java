...
class OnlineTest extends JFrame implements ActionListener
{
    ...
    void set()
    {
        ...
        if(current==4)
        {
            l.setText("Q5: Which of the following statements are true for inheritance in java?");
            jb[0].setText("\"extend\" keyword is used to extend a class in java.");jb[1].setText("We can’t extend Final classes in java.");jb[2].setText("You can extend multiple classes in java.");jb[3].setText("Private members of superclass are accessible to subclass.");
        }
        if(current==5)
        {
